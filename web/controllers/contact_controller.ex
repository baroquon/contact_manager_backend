defmodule ContactManagerBackend.ContactController do
  use ContactManagerBackend.Web, :controller

  alias ContactManagerBackend.Contact
  ...
  def create(conn, %{"contact" => contact_params}) do
    ...
    case Repo.insert(changeset) do
      ...
      {:error, changeset} ->
        ...
        |> render(ContactManagerBackend.ChangesetView, "error.json", changeset: changeset)
    end
  end
